...
public class PixelateEditor : Editor
{
    ...
    private void SaveCapture(Texture2D diffuseMap, Texture2D normalMap, bool createNormalMap, bool useAnimation, Vector2 cellSize, Vector2 pivot)
    {
        ...
        AutoSpriteSlicer.Slice(diffuseAsset, cellSize, pivot, useAnimation);
        ...
        if (createNormalMap)
        {
            ...
            AutoSpriteSlicer.Slice(normalAsset, cellSize, pivot, useAnimation);
        }
    }
}
